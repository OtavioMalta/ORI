...
dataset = pd.read_csv('/workspaces/ORI/TP4/Ex5/reforma_previdencia_rotulado.csv',encoding='utf-8', delimiter=";")
dataset.head()
dataset.count()
...
# TF
vectorizer = CountVectorizer(analyzer="word", ngram_range=(1,1), stop_words=stopwords)
